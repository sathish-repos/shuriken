...
export const CharactersMocks: Characters = {
  characters: [
    {
      id: 1344,
      name: 'Naruto Uzumaki',
      ...
      rank: {
        ninjaRank: { 'Part I': 'Genin', Gaiden: 'Kage' },
      ...
      voiceActors: {
        japanese: ['Junko Takeuchi', 'Ema Kogure   (Sexy Technique)'],
        english: [
          'Maile Flanagan',
    ...
    },
    {
      ...
      voiceActors: {
        japanese: ['Noriaki Sugiyama', 'Nao Tōyama   (Infant and Child)'],
    ...
    },
    {
      ...
      family: { father: 'Tajima Uchiha', brother: 'Izuna Uchiha' },
      jutsu: [
        'Animal Path',
        'Asura Path',
        'Black Receiver',
      ...
      personal: {
        ...
        sex: 'Male',
        status: 'Deceased',
        height: { 'Part II': '179cm' },
        weight: { 'Part II': '71.3kg' },
        bloodType: 'O',
        kekkeiGenkai: [
          'Sharingan',
        ...
        partner: ['Obito Uchiha', 'Black Zetsu'],
        clan: 'Uchiha',
        titles: [
          'うちはマダラUchihaMadara',
      ...
      voiceActors: {
        japanese: ['Naoya Uchida', 'Gō Inoue   (Child)'],
        english: ['Neil Kaplan', 'Xander Mobus   (Child)'],
      },
    },
    {
      id: 376,
      ...
      rank: {
        ninjaRank: { 'Part I': 'Jōnin', 'Blank Period': 'Kage' },
      ...
      voiceActors: {
        ...
        english: ['Dave Wittenberg', 'Xander Mobus   (Sukea)'],
      },
    },
    {
      id: 928,
      ...
      personal: {
        ...
        age: { 'Part I': '50–51', 'Part II': '54', 'Academy Graduate': '6' },
        height: {
          'Part I': '179.4cm - 172cm',
          'Part II': '172cm',
          Gaiden: '179.5cm',
        },
        weight: { 'Part I': '63.9kg - 57.3kg', 'Part II': '57.3kg' },
        bloodType: 'B',
        kekkeiGenkai: [
        ...
        partner: ['Sasori', 'Kabuto Yakushi'],
      },
      rank: { ninjaRank: { 'Part I': 'Anbu' }, ninjaRegistration: '002300' },
      tools: [
    ...
    },
    {
      ...
      family: { 'grandmother ': "Obito's Grandmother" },
      jutsu: [
        'Animal Path',
        'Asura Path',
        'Black Receiver',
      ...
      personal: {
        ...
        status: 'Deceased',
        height: { 'Part I': '154.2cm', 'Part II': '175cm - 182cm' },
        weight: { 'Part I': '44.5kg', 'Part II': '55.9kg - 70.3kg' },
        bloodType: 'O',
        kekkeiGenkai: [
          'Sharingan',
          'Mangekyō Sharingan',
        ...
        team: 'Team Minato',
        partner: ['Madara Uchiha', 'Deidara', 'Zetsu'],
        clan: 'Uchiha',
        titles: [
          'うちはオビトUchihaObito',
          'tobi(トビ)',
      ...
      rank: { ninjaRank: { 'Part I': 'Chūnin' }, ninjaRegistration: '010886' },
      tools: [
        'Fūma Shuriken',
        'Gunbai',
        'Kusari',
    ...
    },
    {
      ...
      personal: {
        ...
        weight: { 'Part I': '39kg - 40.2kg', 'Part II': '50.9kg' },
        bloodType: 'AB',
      ...
      uniqueTraits: ['Sand manipulation'],
      voiceActors: { japanese: 'Akira Ishida', english: "Liam O'Brien" },
    },
    {
      id: 1359,
      name: 'Kabuto Yakushi',
    ...
    },
    {
      ...
      family: { clone: 'Koji Kashin', godson: 'Naruto Uzumaki' },
      jutsu: [
      ...
      personal: {
        ...
        age: { 'Part I': '50–51', 'Part II': '54', 'Academy Graduate': '6' },
        status: 'Deceased',
        height: { 'Part I': '191.2cm' },
        weight: { 'Part I': '87.5kg' },
        bloodType: 'B',
        classification: ['Sage', 'Sannin'],
        occupation: 'Writer',
        affiliation: ['Konohagakure', 'Mount Myōboku'],
        team: ['Team Hiruzen', 'Ame Orphans', 'Team Jiraiya'],
      },
      rank: { ninjaRank: { 'Part I': 'Jōnin' }, ninjaRegistration: '002301' },
      tools: [
        'Chakra-Suppressing Seal',
        'Fūma Shuriken',
      ...
      voiceActors: {
        japanese: ['Hōchū Ōtsuka', 'Tōru Nara   (Child)'],
        english: [
          'David Lodge',
    ...
    },
    {
      ...
      personal: {
        ...
        height: { 'Part II': '178cm' },
        weight: { 'Part II': '58.4kg' },
        bloodType: 'A',
      ...
      rank: {
        ninjaRank: { 'Part II': 'Anbu', Gaiden: 'Jōnin' },
      ...
      voiceActors: {
        japanese: ['Rikiya Koyama', 'Eri Gōda   (Child)'],
        english: [
    ...
    },
    {
      ...
      natureType: ['Fire Release', 'Lightning Release'],
      personal: {
        birthdate: 'January 1',
        sex: 'Male',
        age: {
        ...
        team: ['Team Chōza', 'Team Guy', 'Third Division'],
      },
      rank: { ninjaRank: { 'Part I': 'Jōnin' }, ninjaRegistration: '010252' },
      tools: [
        'Bow & Arrow (Anime only)',
        'Kusarigama (Anime only)',
        'Nunchaku',
      ...
      voiceActors: {
        japanese: ['Masashi Ebara', 'Mayuki Makiguchi   (Child)'],
        english: ['Skip Stellrecht', 'Todd Haberkorn   (Child)'],
      },
    },
    {
      id: 1037,
      ...
      personal: {
        ...
        sex: 'Male',
        age: { 'Part I': '8–9', 'Part II': '11–12' },
        height: {
          'Part I': '128.8cm - 130.6cm',
          'Part II': '141.1cm',
          Gaiden: '177.5cm',
        },
        weight: { 'Part I': '27.8kg - 29.5kg', 'Part II': '36.9kg' },
        bloodType: 'B',
        occupation: [
        ...
        affiliation: ['Konohagakure', 'Mount Myōboku  (Anime only)'],
        team: ['Team Ebisu', 'Team 7'],
        clan: 'Sarutobi',
        titles: [
      ...
      voiceActors: {
        ...
        english: ['Colleen Villard', 'Max Mittelman   (Adult)'],
      },
    },
    {
      id: 813,
      ...
      personal: {
        ...
        classification: ['Medical-nin', 'Sage', 'Sensor Type'],
        affiliation: ['Otogakure', 'Ryūchi Cave', 'Konohagakure'],
        team: 'Team 7',
      },
      rank: { ninjaRank: { Gaiden: 'Genin' } },
      tools: ['Poison', 'Sword'],
      voiceActors: { japanese: 'Ryūichi Kijima', english: 'Robbie Daymond' },
    },
    {
      id: 865,
      ...
      personal: {
        ...
        sex: 'Male',
        age: { 'Part II': '24', 'Academy Graduate': '10' },
        status: 'Deceased',
        height: { 'Part I': '179.2cm' },
        weight: { 'Part I': '66.1kg' },
        bloodType: 'B',
        classification: ['Jinchūriki', 'Sage', 'Sensor Type'],
      ...
      rank: { ninjaRank: { 'Part I': 'Kage' }, ninjaRegistration: '006510' },
      tools: ['Flying Thunder God Kunai'],
      voiceActors: {
        japanese: ['Toshiyuki Morikawa', 'Miyu Irino   (Child)'],
        english: 'Tony Oliver',
      },
    },
    {
      ...
      personal: {
        ...
        affiliation: ['Konohagakure', 'Ryūchi Cave  (Anime only)'],
        team: 'Team 7',
        clan: ['Uzumaki', 'Hyūga Clan'],
        titles: ['うずまきボルトUzumakiBoruto'],
      },
      rank: { ninjaRank: { Gaiden: 'Genin' } },
      tools: [
        'Chakra Blade',
    ...
    },
    {
      ...
      rank: { ninjaRank: { 'Part I': 'Kage' } },
      tools: ["First Hokage's Necklace", 'Sword'],
      voiceActors: {
        japanese: ['Takayuki Sugō', 'Yūki Tai   (Child)'],
        english: [
          'Jamieson Price',
          'Peter Lurie   (Part II)',
    ...
    },
    {
      ...
      personal: {
        birthdate: 'August 2',
        sex: 'Female',
        age: { 'Part I': '51', 'Part II': '54–55', 'Academy Graduate': '6' },
        height: { 'Part I': '163.1cm', 'Part II': '163.1cm' },
        weight: { 'Part I': '48.9kg', 'Part II': '48.9kg' },
        bloodType: 'B',
      ...
      rank: { ninjaRank: { 'Part I': 'Kage' }, ninjaRegistration: '002302' },
      tools: [
        'Antidote',
      ...
      voiceActors: {
        japanese: ['Masako Katsuki', 'Haruhi Terada   (Child)'],
        english: [
          'Debi Mae West',
    ...
    },
    {
      ...
      personal: {
        ...
        weight: { 'Part I': '46.6kg - 47.5kg', 'Part II': '54.7kg' },
        bloodType: 'A',
      ...
      rank: {
        ninjaRank: { 'Part I': 'Genin', 'Part II': 'Chūnin', Gaiden: 'Jōnin' },
      ...
      voiceActors: { japanese: 'Yōichi Masukawa', english: 'Brian Donovan' },
    },
    {
      id: 600,
      name: 'Koji Kashin',
