...
export const TailedBeastsMocks: TailedBeasts = {
  'tailed-beasts': [
    {
      id: 1,
      name: 'Ten-Tails',
    ...
    },
    {
      ...
      name: 'Chōmei',
      images: [
        'https://static.wikia.nocookie.net/naruto/images/7/78/Chomei.png',
      ],
      debut: {
        manga: 'Naruto Chapter #467',
      ...
      family: { creator: 'Hagoromo Ōtsutsuki', sibling: 'Kurama' },
      jutsu: [
        'Bug Bite',
      ...
      voiceActors: { japanese: 'Kenichi Suzumura', english: 'Steven Blum' },
    },
    {
      id: 345,
      name: 'Gyūki',
      images: [
        'https://static.wikia.nocookie.net/naruto/images/d/d7/Gyuki.png',
      ],
      debut: {
        manga: 'Naruto Chapter #413',
        anime: 'Naruto Shippūden Episode #143',
        novel: 'The Last: Naruto the Movie',
      ...
      personal: {
        species: 'Ushi-oni',
        classification: 'Tailed Beast',
        jinchūriki: ['Blue B', 'Killer B', 'Obito Uchiha', 'Naruto Uzumaki'],
        affiliation: ['Kumogakure', 'Allied Shinobi Forces'],
      },
      uniqueTraits: ['Produces ink'],
      voiceActors: {
        japanese: 'Masaki Aizawa',
        english: [
          'Matthew Mercer',
          'Fred Tatasciore   (Naruto Shippūden: Ultimate Ninja Storm 3)',
        ],
      },
    },
    {
      ...
      debut: {
        manga: 'Naruto Chapter #317',
        anime: 'Naruto Shippūden Episode #92',
        novel: 'The Last: Naruto the Movie',
        movie: 'The Last: Naruto the Movie',
      ...
      jutsu: [
        ...
        'Tailed Beast Telepathy',
        'Three-Tails Mini Clone (Anime only)',
        'Water Release: Great Water Mass Bullet (Anime only)',
      ],
      natureType: ['Water Release', 'Yin Release  (Anime only)'],
      personal: {
        species: 'Turtle',
        classification: 'Tailed Beast',
        jinchūriki: ['Rin Nohara', 'Yagura Karatachi', 'Naruto Uzumaki'],
        affiliation: 'Kirigakure',
      },
      uniqueTraits: ['Produces Coral'],
      voiceActors: { japanese: 'Shigenori Sōya', english: 'Chris Edgerly' },
    },
    {
      id: 669,
      name: 'Kokuō',
      images: [
        'https://static.wikia.nocookie.net/naruto/images/a/a3/Kokuo.png',
      ],
      debut: {
        manga: 'Naruto Chapter #467',
        anime: 'Naruto Shippūden Episode #165',
      ...
      natureType: ['Boil Release', 'Fire Release', 'Water Release'],
      personal: {
        kekkeiGenkai: 'Boil Release',
        classification: 'Tailed Beast',
        jinchūriki: ['Han', 'Naruto Uzumaki'],
    ...
    },
    {
      ...
      family: { creator: 'Hagoromo Ōtsutsuki', sibling: 'Gyūki' },
      jutsu: [
        'The Springtime of Youth wiki has an article about this topic:',
        'Nine-Tails',
      ],
      natureType: ['Fire Release  (Anime only)', 'Wind Release  (Anime only)'],
      personal: {
        species: 'Kitsune',
        status: 'Deceased',
      ...
      uniqueTraits: ['Detects negative emotions'],
      voiceActors: { japanese: 'Tesshō Genda', english: 'Paul St. Peter' },
    },
    {
      id: 771,
      name: 'Matatabi',
      images: [
        'https://static.wikia.nocookie.net/naruto/images/a/a7/Matatabi.png',
      ],
      debut: {
      ...
      uniqueTraits: ['Produce blue flames'],
      voiceActors: { japanese: 'Ryōko Shiraishi', english: 'Cristina Vee' },
    },
    {
      id: 1009,
      name: 'Saiken',
      images: [
        'https://static.wikia.nocookie.net/naruto/images/5/58/Saiken.png',
      ],
      debut: {
        manga: 'Naruto Chapter #467',
      ...
      uniqueTraits: ['Secretes corrosive alkali'],
      voiceActors: { japanese: 'Miyu Irino', english: 'Todd Haberkorn' },
    },
    {
      id: 1127,
      name: 'Shukaku',
      images: [
        'https://static.wikia.nocookie.net/naruto/images/9/99/Shukaku.png',
      ],
      debut: {
      ...
      natureType: ['Magnet Release', 'Wind Release', 'Earth Release'],
      personal: {
        species: 'Tanuki',
        kekkeiGenkai: 'Magnet Release',
        classification: 'Tailed Beast',
        jinchūriki: ['Bunpuku', 'Gaara', 'Obito Uchiha', 'Naruto Uzumaki'],
      ...
      voiceActors: {
        ...
        english: ['Kirk Thornton', "Liam O'Brien   (Video games)"],
      },
    },
    {
      id: 1134,
      name: 'Son Gokū',
      images: [
        'https://static.wikia.nocookie.net/naruto/images/5/5e/Son_Goku.png',
      ],
      debut: {
        manga: 'Naruto Chapter #467',
        anime: 'Naruto Shippūden Episode #165',
      ...
      natureType: ['Lava Release', 'Fire Release', 'Earth Release'],
      personal: {
        species: 'Monkey',
        kekkeiGenkai: 'Lava Release',
        classification: ['Tailed Beast', 'Sage'],
        jinchūriki: ['Rōshi', 'Naruto Uzumaki'],
        affiliation: 'Iwagakure',
      },
      voiceActors: {
        japanese: 'Hiroki Yasumoto',
        english: 'John Eric Bentley',
      },
    },
  ],
  currentPage: 1,
